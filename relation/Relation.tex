...
\subsection{Struttura: layout e css}
...
\item \textbf{Layout per dispositivi smartphone: \textit{Media = ''handheld''}}\\
...
E' stato quindi creato un layout verticale, nel quale è stato mantenuto l'Header, mentre il Left contenente il menu è stato posto centralmente sotto il Nav; al di sotto di esso possiamo successivamente trovare il Center e il Footer. Il Right è stato tolto in quanto non contiene informazioni fondamentali alla navigazione.
...
Le immagini che riguardano il solo layout, sono state inserite attraverso il foglio di stile con l'utilizzo del comando \textbf{background}, come per esempio l'immagine dell'Header.\\
