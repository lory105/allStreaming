...
\red{testare con il validatore colori IE accessibility toolbar da fare lun in laboratorio}
...
Ogni contenuto principale è stato corredato di un ''id'' univoco che permette.. \red{lucaaa !}
